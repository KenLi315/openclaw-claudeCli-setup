 ...
 * 接收 OpenClaw Hooks 的 POST（User 即時 + Assistant session-sync），寫入 MongoDB
...
const server = createServer(async (req, res) => {
  ...
  try {
    ...
    console.error("[openclaw-conversation-storer] Error:", err);
...
server.listen(PORT, () => {
  console.log(`OpenClaw conversation storer listening on port ${PORT}`);
